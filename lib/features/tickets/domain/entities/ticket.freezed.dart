...
@JsonKey(name: 'id') String get ticketId;@JsonKey(name: 'customer_id') String get customerId;@JsonKey(name: 'client_ticket_uuid') String? get clientTicketUuid;@JsonKey(name: 'title') String get title;@JsonKey(name: 'description') String? get description;@JsonKey(name: 'contact_phone') String? get contactPhone;@JsonKey(name: 'screenshot_url') String? get screenshotUrl;@JsonKey(name: 'category') String? get category;@JsonKey(name: 'status') String get status;@JsonKey(name: 'priority') String? get priority;@JsonKey(name: 'ticket_number') int? get ticketNumber;@JsonKey(name: 'created_by') String get createdBy;@JsonKey(name: 'assigned_to') String? get assignedTo;@JsonKey(name: 'created_at')@UtcDateTimeConverter() DateTime? get createdAt;@JsonKey(name: 'updated_at')@UtcDateTimeConverter() DateTime? get updatedAt;@JsonKey(name: 'sla_due')@UtcDateTimeConverter() DateTime? get slaDue;@JsonKey(name: 'bill_amount') double? get billAmount;@JsonKey(name: 'bill_description') String? get billDescription;@JsonKey(name: 'billing_procedure') String? get billingProcedure;@JsonKey(name: 'payment_collected') bool? get paymentCollected;@JsonKey(name: 'has_amc') bool? get hasAmc;@JsonKey(name: 'completed_at')@UtcDateTimeConverter() DateTime? get completedDate;@JsonKey(name: 'zoho_channel_id') String? get zohoChannelId;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('ticketId', ticketId))..add(DiagnosticsProperty('customerId', customerId))..add(DiagnosticsProperty('clientTicketUuid', clientTicketUuid))..add(DiagnosticsProperty('title', title))..add(DiagnosticsProperty('description', description))..add(DiagnosticsProperty('contactPhone', contactPhone))..add(DiagnosticsProperty('screenshotUrl', screenshotUrl))..add(DiagnosticsProperty('category', category))..add(DiagnosticsProperty('status', status))..add(DiagnosticsProperty('priority', priority))..add(DiagnosticsProperty('ticketNumber', ticketNumber))..add(DiagnosticsProperty('createdBy', createdBy))..add(DiagnosticsProperty('assignedTo', assignedTo))..add(DiagnosticsProperty('createdAt', createdAt))..add(DiagnosticsProperty('updatedAt', updatedAt))..add(DiagnosticsProperty('slaDue', slaDue))..add(DiagnosticsProperty('billAmount', billAmount))..add(DiagnosticsProperty('billDescription', billDescription))..add(DiagnosticsProperty('billingProcedure', billingProcedure))..add(DiagnosticsProperty('paymentCollected', paymentCollected))..add(DiagnosticsProperty('hasAmc', hasAmc))..add(DiagnosticsProperty('completedDate', completedDate))..add(DiagnosticsProperty('zohoChannelId', zohoChannelId));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Ticket&&(identical(other.ticketId, ticketId) || other.ticketId == ticketId)&&(identical(other.customerId, customerId) || other.customerId == customerId)&&(identical(other.clientTicketUuid, clientTicketUuid) || other.clientTicketUuid == clientTicketUuid)&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&(identical(other.contactPhone, contactPhone) || other.contactPhone == contactPhone)&&(identical(other.screenshotUrl, screenshotUrl) || other.screenshotUrl == screenshotUrl)&&(identical(other.category, category) || other.category == category)&&(identical(other.status, status) || other.status == status)&&(identical(other.priority, priority) || other.priority == priority)&&(identical(other.ticketNumber, ticketNumber) || other.ticketNumber == ticketNumber)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&(identical(other.assignedTo, assignedTo) || other.assignedTo == assignedTo)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.slaDue, slaDue) || other.slaDue == slaDue)&&(identical(other.billAmount, billAmount) || other.billAmount == billAmount)&&(identical(other.billDescription, billDescription) || other.billDescription == billDescription)&&(identical(other.billingProcedure, billingProcedure) || other.billingProcedure == billingProcedure)&&(identical(other.paymentCollected, paymentCollected) || other.paymentCollected == paymentCollected)&&(identical(other.hasAmc, hasAmc) || other.hasAmc == hasAmc)&&(identical(other.completedDate, completedDate) || other.completedDate == completedDate)&&(identical(other.zohoChannelId, zohoChannelId) || other.zohoChannelId == zohoChannelId));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,ticketId,customerId,clientTicketUuid,title,description,contactPhone,screenshotUrl,category,status,priority,ticketNumber,createdBy,assignedTo,createdAt,updatedAt,slaDue,billAmount,billDescription,billingProcedure,paymentCollected,hasAmc,completedDate,zohoChannelId]);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'Ticket(ticketId: $ticketId, customerId: $customerId, clientTicketUuid: $clientTicketUuid, title: $title, description: $description, contactPhone: $contactPhone, screenshotUrl: $screenshotUrl, category: $category, status: $status, priority: $priority, ticketNumber: $ticketNumber, createdBy: $createdBy, assignedTo: $assignedTo, createdAt: $createdAt, updatedAt: $updatedAt, slaDue: $slaDue, billAmount: $billAmount, billDescription: $billDescription, billingProcedure: $billingProcedure, paymentCollected: $paymentCollected, hasAmc: $hasAmc, completedDate: $completedDate, zohoChannelId: $zohoChannelId)';
}
...
@useResult
$Res call({
@JsonKey(name: 'id') String ticketId,@JsonKey(name: 'customer_id') String customerId,@JsonKey(name: 'client_ticket_uuid') String? clientTicketUuid,@JsonKey(name: 'title') String title,@JsonKey(name: 'description') String? description,@JsonKey(name: 'contact_phone') String? contactPhone,@JsonKey(name: 'screenshot_url') String? screenshotUrl,@JsonKey(name: 'category') String? category,@JsonKey(name: 'status') String status,@JsonKey(name: 'priority') String? priority,@JsonKey(name: 'ticket_number') int? ticketNumber,@JsonKey(name: 'created_by') String createdBy,@JsonKey(name: 'assigned_to') String? assignedTo,@JsonKey(name: 'created_at')@UtcDateTimeConverter() DateTime? createdAt,@JsonKey(name: 'updated_at')@UtcDateTimeConverter() DateTime? updatedAt,@JsonKey(name: 'sla_due')@UtcDateTimeConverter() DateTime? slaDue,@JsonKey(name: 'bill_amount') double? billAmount,@JsonKey(name: 'bill_description') String? billDescription,@JsonKey(name: 'billing_procedure') String? billingProcedure,@JsonKey(name: 'payment_collected') bool? paymentCollected,@JsonKey(name: 'has_amc') bool? hasAmc,@JsonKey(name: 'completed_at')@UtcDateTimeConverter() DateTime? completedDate,@JsonKey(name: 'zoho_channel_id') String? zohoChannelId
});
...
/// Create a copy of Ticket
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? ticketId = null,Object? customerId = null,Object? clientTicketUuid = freezed,Object? title = null,Object? description = freezed,Object? contactPhone = freezed,Object? screenshotUrl = freezed,Object? category = freezed,Object? status = null,Object? priority = freezed,Object? ticketNumber = freezed,Object? createdBy = null,Object? assignedTo = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? slaDue = freezed,Object? billAmount = freezed,Object? billDescription = freezed,Object? billingProcedure = freezed,Object? paymentCollected = freezed,Object? hasAmc = freezed,Object? completedDate = freezed,Object? zohoChannelId = freezed,}) {
...
as double?,billDescription: freezed == billDescription ? _self.billDescription : billDescription // ignore: cast_nullable_to_non_nullable
as String?,billingProcedure: freezed == billingProcedure ? _self.billingProcedure : billingProcedure // ignore: cast_nullable_to_non_nullable
...
as DateTime?,zohoChannelId: freezed == zohoChannelId ? _self.zohoChannelId : zohoChannelId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'id')  String ticketId, @JsonKey(name: 'customer_id')  String customerId, @JsonKey(name: 'client_ticket_uuid')  String? clientTicketUuid, @JsonKey(name: 'title')  String title, @JsonKey(name: 'description')  String? description, @JsonKey(name: 'contact_phone')  String? contactPhone, @JsonKey(name: 'screenshot_url')  String? screenshotUrl, @JsonKey(name: 'category')  String? category, @JsonKey(name: 'status')  String status, @JsonKey(name: 'priority')  String? priority, @JsonKey(name: 'ticket_number')  int? ticketNumber, @JsonKey(name: 'created_by')  String createdBy, @JsonKey(name: 'assigned_to')  String? assignedTo, @JsonKey(name: 'created_at')@UtcDateTimeConverter()  DateTime? createdAt, @JsonKey(name: 'updated_at')@UtcDateTimeConverter()  DateTime? updatedAt, @JsonKey(name: 'sla_due')@UtcDateTimeConverter()  DateTime? slaDue, @JsonKey(name: 'bill_amount')  double? billAmount, @JsonKey(name: 'bill_description')  String? billDescription, @JsonKey(name: 'billing_procedure')  String? billingProcedure, @JsonKey(name: 'payment_collected')  bool? paymentCollected, @JsonKey(name: 'has_amc')  bool? hasAmc, @JsonKey(name: 'completed_at')@UtcDateTimeConverter()  DateTime? completedDate, @JsonKey(name: 'zoho_channel_id')  String? zohoChannelId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Ticket() when $default != null:
return $default(_that.ticketId,_that.customerId,_that.clientTicketUuid,_that.title,_that.description,_that.contactPhone,_that.screenshotUrl,_that.category,_that.status,_that.priority,_that.ticketNumber,_that.createdBy,_that.assignedTo,_that.createdAt,_that.updatedAt,_that.slaDue,_that.billAmount,_that.billDescription,_that.billingProcedure,_that.paymentCollected,_that.hasAmc,_that.completedDate,_that.zohoChannelId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'id')  String ticketId, @JsonKey(name: 'customer_id')  String customerId, @JsonKey(name: 'client_ticket_uuid')  String? clientTicketUuid, @JsonKey(name: 'title')  String title, @JsonKey(name: 'description')  String? description, @JsonKey(name: 'contact_phone')  String? contactPhone, @JsonKey(name: 'screenshot_url')  String? screenshotUrl, @JsonKey(name: 'category')  String? category, @JsonKey(name: 'status')  String status, @JsonKey(name: 'priority')  String? priority, @JsonKey(name: 'ticket_number')  int? ticketNumber, @JsonKey(name: 'created_by')  String createdBy, @JsonKey(name: 'assigned_to')  String? assignedTo, @JsonKey(name: 'created_at')@UtcDateTimeConverter()  DateTime? createdAt, @JsonKey(name: 'updated_at')@UtcDateTimeConverter()  DateTime? updatedAt, @JsonKey(name: 'sla_due')@UtcDateTimeConverter()  DateTime? slaDue, @JsonKey(name: 'bill_amount')  double? billAmount, @JsonKey(name: 'bill_description')  String? billDescription, @JsonKey(name: 'billing_procedure')  String? billingProcedure, @JsonKey(name: 'payment_collected')  bool? paymentCollected, @JsonKey(name: 'has_amc')  bool? hasAmc, @JsonKey(name: 'completed_at')@UtcDateTimeConverter()  DateTime? completedDate, @JsonKey(name: 'zoho_channel_id')  String? zohoChannelId)  $default,) {final _that = this;
switch (_that) {
case _Ticket():
return $default(_that.ticketId,_that.customerId,_that.clientTicketUuid,_that.title,_that.description,_that.contactPhone,_that.screenshotUrl,_that.category,_that.status,_that.priority,_that.ticketNumber,_that.createdBy,_that.assignedTo,_that.createdAt,_that.updatedAt,_that.slaDue,_that.billAmount,_that.billDescription,_that.billingProcedure,_that.paymentCollected,_that.hasAmc,_that.completedDate,_that.zohoChannelId);case _:
  throw StateError('Unexpected subclass');
...
class _Ticket with DiagnosticableTreeMixin implements Ticket {
  const _Ticket({@JsonKey(name: 'id') required this.ticketId, @JsonKey(name: 'customer_id') required this.customerId, @JsonKey(name: 'client_ticket_uuid') this.clientTicketUuid, @JsonKey(name: 'title') this.title = '', @JsonKey(name: 'description') this.description, @JsonKey(name: 'contact_phone') this.contactPhone, @JsonKey(name: 'screenshot_url') this.screenshotUrl, @JsonKey(name: 'category') this.category, @JsonKey(name: 'status') this.status = 'New', @JsonKey(name: 'priority') this.priority, @JsonKey(name: 'ticket_number') this.ticketNumber, @JsonKey(name: 'created_by') this.createdBy = 'Unknown', @JsonKey(name: 'assigned_to') this.assignedTo, @JsonKey(name: 'created_at')@UtcDateTimeConverter() this.createdAt, @JsonKey(name: 'updated_at')@UtcDateTimeConverter() this.updatedAt, @JsonKey(name: 'sla_due')@UtcDateTimeConverter() this.slaDue, @JsonKey(name: 'bill_amount') this.billAmount, @JsonKey(name: 'bill_description') this.billDescription, @JsonKey(name: 'billing_procedure') this.billingProcedure, @JsonKey(name: 'payment_collected') this.paymentCollected, @JsonKey(name: 'has_amc') this.hasAmc, @JsonKey(name: 'completed_at')@UtcDateTimeConverter() this.completedDate, @JsonKey(name: 'zoho_channel_id') this.zohoChannelId});
...
@override@JsonKey(name: 'ticket_number') final  int? ticketNumber;
...
@override@JsonKey(name: 'bill_description') final  String? billDescription;
...
@override@JsonKey(name: 'zoho_channel_id') final  String? zohoChannelId;
