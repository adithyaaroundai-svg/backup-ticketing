...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,ticketId,customerId,clientTicketUuid,title,description,contactPhone,screenshotUrl,category,status,priority,createdBy,assignedTo,createdAt,updatedAt,slaDue,billAmount,billDescription,billingProcedure,paymentCollected,hasAmc,completedDate,zohoChannelId]);
