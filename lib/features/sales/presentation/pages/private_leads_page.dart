...
class _LeadCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final String currentStatus = lead.status == 'pending' || lead.status == 'New' ? 'New Lead' : (lead.status ?? 'New Lead');
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if ((isMarketingAI && lead.phoneNumber != null && lead.phoneNumber!.isNotEmpty) || stageIndex >= 0) ...[
                  const SizedBox(height: 6),
                  Row(
                    children: [
                      if (isMarketingAI && lead.phoneNumber != null && lead.phoneNumber!.isNotEmpty) ...[
                      ...
                      if (stageIndex >= 0) ...[
                        if (stageIndex > 0)
                          InkWell(
                            onTap: () => onStageChange(pipelineStages[stageIndex - 1]),
                            child: Padding(
